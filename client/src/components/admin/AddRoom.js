  ...
  async function addRoom() {
    ...
    try {
      ...
      Swal.fire(
        ...
        "The new room has been added to the database successfully.",
        "success"
      ).then((result) => {
  ...
  return (
    <div className="row">
      ...
      <div className="col-md-5">
        ...
        <FileBase64
          multiple={false}
          onDone={({ base64 }) => setImageURL1(base64)}
        />

        <FileBase64
          multiple={false}
          onDone={({ base64 }) => setImageURL2(base64)}
        />

        <FileBase64
          multiple={false}
          onDone={({ base64 }) => setImageURL3(base64)}
        />
